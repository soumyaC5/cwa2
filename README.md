...
```
This command will create your personal repository under `/Repos/<username>/cwa`.
...
- To trigger the release pipeline, get the current version from the `cwa/__init__.py` file and tag the current code version:
```
